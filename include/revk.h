...
const char *revk_build_date (esp_app_desc_t *app,char d[20]);       // Get build date ISO formatted
#define revk_build_date revk_build_date_app(esp_app_get_description(),d)
